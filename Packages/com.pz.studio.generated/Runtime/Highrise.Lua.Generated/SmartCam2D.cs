...
namespace Highrise.Lua.Generated
{
    ...
    public class SmartCam2D : LuaBehaviourThunk
    {
        ...
        [SerializeField] public System.Double m_panSensitivity = 70;
        ...
        protected override SerializedPropertyValue[] SerializeProperties()
        {
            ...
            return new SerializedPropertyValue[]
            {
                ...
                CreateSerializedProperty(_script.GetPropertyAt(9), m_panSensitivity),
                CreateSerializedProperty(_script.GetPropertyAt(10), m_mobileZoomSensitivity),
                CreateSerializedProperty(_script.GetPropertyAt(11), m_boundary),
                CreateSerializedProperty(_script.GetPropertyAt(12), m_minBoundaryX),
                CreateSerializedProperty(_script.GetPropertyAt(13), m_maxBoundaryX),
                CreateSerializedProperty(_script.GetPropertyAt(14), m_minBoundaryY),
                CreateSerializedProperty(_script.GetPropertyAt(15), m_maxBoundaryY),
                CreateSerializedProperty(_script.GetPropertyAt(16), m_deadzone),
                CreateSerializedProperty(_script.GetPropertyAt(17), m_deadzoneWidth),
                CreateSerializedProperty(_script.GetPropertyAt(18), m_deadzoneHeight),
            };
        }
    }
}
