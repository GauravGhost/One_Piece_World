...
--!SerializeField
local panSensitivity : number = 70 -- The sensitivity of the camera pan
--!SerializeField
...
function ConvertSensitivity(userInput)
  ...
  local decimal = 0.002 -- Converted to 0-100 scale
